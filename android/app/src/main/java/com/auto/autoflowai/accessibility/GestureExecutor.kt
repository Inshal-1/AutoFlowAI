package com.auto.autoflow.accessibility
...
class GestureExecutor(private val service: AutoFlowAccessibilityService) {
    ...
    private fun executeClipboardSet(text: String): ActionResult {
        ...
        val clip = android.content.ClipData.newPlainText("autoflow", text)
