...
import com.auto.autoflow.model.UIElement
...
object ScreenTreeBuilder {
    ...
    private fun walkTree(
        ...
        try {
            // Skip AutoFlow's own overlay nodes so the agent never sees them
            if (node.packageName?.toString() == "com.auto.autoflow") return
